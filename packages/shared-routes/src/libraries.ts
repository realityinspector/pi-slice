...
import type { ElementId, EntityId, Element, CreateLibraryInput } from '@slice/core';
import { createLibrary } from '@slice/core';
...
export function createLibraryRoutes(services: CollaborateServices) {
  ...
  app.get('/api/libraries', async (c) => {
    try {
      ...
      console.error('[slice] Failed to get libraries:', error);
  ...
  app.get('/api/libraries/:id', async (c) => {
    try {
      ...
      console.error('[slice] Failed to get library:', error);
  ...
  app.get('/api/libraries/:id/documents', async (c) => {
    try {
      ...
      console.error('[slice] Failed to get library documents:', error);
  ...
  app.put('/api/libraries/:id/order', async (c) => {
    try {
      ...
      console.error('[slice] Failed to reorder library:', error);
  ...
  app.put('/api/libraries/:id/parent', async (c) => {
    try {
      ...
      console.error('[slice] Failed to move library:', error);
  ...
  app.delete('/api/libraries/:id', async (c) => {
    try {
      ...
      console.error('[slice] Failed to delete library:', error);
  ...
  app.post('/api/libraries', async (c) => {
    try {
      ...
      console.error('[slice] Failed to create library:', error);
