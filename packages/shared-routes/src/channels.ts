...
import type { ElementId, EntityId, Channel, Entity, Visibility, JoinPolicy } from '@slice/core';
import { createGroupChannel, createDirectChannel } from '@slice/core';
import type { CreateGroupChannelInput, CreateDirectChannelInput, Element } from '@slice/core';
...
export function createChannelRoutes(services: CollaborateServices) {
  ...
  app.get('/api/channels', async (c) => {
    try {
      ...
      console.error('[slice] Failed to get channels:', error);
  ...
  app.get('/api/channels/:id', async (c) => {
    try {
      ...
      console.error('[slice] Failed to get channel:', error);
  ...
  app.post('/api/channels', async (c) => {
    try {
      ...
      console.error('[slice] Failed to create channel:', error);
  ...
  app.get('/api/channels/:id/messages', async (c) => {
    try {
      ...
      console.error('[slice] Failed to get channel messages:', error);
  ...
  app.get('/api/channels/:id/members', async (c) => {
    try {
      ...
      console.error('[slice] Failed to get channel members:', error);
  ...
  app.post('/api/channels/:id/members', async (c) => {
    try {
      ...
      console.error('[slice] Failed to add channel member:', error);
  ...
  app.delete('/api/channels/:id/members/:entityId', async (c) => {
    try {
      ...
      console.error('[slice] Failed to remove channel member:', error);
  ...
  app.post('/api/channels/:id/leave', async (c) => {
    try {
      ...
      console.error('[slice] Failed to leave channel:', error);
  ...
  app.post('/api/channels/:id/merge', async (c) => {
    try {
      ...
      console.error('[slice] Failed to merge channels:', error);
  ...
  app.delete('/api/channels/:id', async (c) => {
    try {
      ...
      console.error('[slice] Failed to delete channel:', error);
