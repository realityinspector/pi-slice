...
import type { ElementId, EntityId, Element, Document, DocumentId, CreateDocumentInput, DocumentCategory, DocumentStatus, EventType } from '@slice/core';
import { createDocument, isValidDocumentCategory, isValidDocumentStatus, DocumentStatus as DocumentStatusEnum, ContentType, validateContent, createEvent, createTimestamp } from '@slice/core';
...
export function createDocumentRoutes(services: CollaborateServices) {
  ...
  app.get('/api/documents', async (c) => {
    try {
      ...
      console.error('[slice] Failed to get documents:', error);
  ...
  app.get('/api/documents/search', async (c) => {
    try {
      ...
      console.error('[slice] Failed to search documents:', error);
  ...
  app.get('/api/documents/:id', async (c) => {
    try {
      ...
      console.error('[slice] Failed to get document:', error);
  ...
  app.post('/api/documents', async (c) => {
    try {
      ...
      console.error('[slice] Failed to create document:', error);
  ...
  app.patch('/api/documents/:id', async (c) => {
    try {
      ...
      console.error('[slice] Failed to update document:', error);
  ...
  app.post('/api/documents/:id/archive', async (c) => {
    try {
      ...
      console.error('[slice] Failed to archive document:', error);
  ...
  app.post('/api/documents/:id/unarchive', async (c) => {
    try {
      ...
      console.error('[slice] Failed to unarchive document:', error);
  ...
  app.delete('/api/documents/:id', async (c) => {
    try {
      ...
      console.error('[slice] Failed to delete document:', error);
  ...
  app.get('/api/documents/:id/versions', async (c) => {
    try {
      ...
      console.error('[slice] Failed to get document versions:', error);
  ...
  app.get('/api/documents/:id/versions/:version', async (c) => {
    try {
      ...
      console.error('[slice] Failed to get document version:', error);
  ...
  app.post('/api/documents/:id/restore', async (c) => {
    try {
      ...
      console.error('[slice] Failed to restore document version:', error);
  ...
  app.post('/api/documents/:id/clone', async (c) => {
    try {
      ...
      console.error('[slice] Failed to clone document:', error);
  ...
  app.get('/api/documents/:id/links', async (c) => {
    try {
      ...
      console.error('[slice] Failed to get document links:', error);
  ...
  app.post('/api/documents/:id/links', async (c) => {
    try {
      ...
      console.error('[slice] Failed to link documents:', error);
  ...
  app.delete('/api/documents/:sourceId/links/:targetId', async (c) => {
    try {
      ...
      console.error('[slice] Failed to remove document link:', error);
  ...
  app.put('/api/documents/:id/library', async (c) => {
    try {
      ...
      console.error('[slice] Failed to move document to library:', error);
  ...
  app.delete('/api/documents/:id/library', async (c) => {
    try {
      ...
      console.error('[slice] Failed to remove document from library:', error);
  ...
  app.get('/api/documents/:id/comments', async (c) => {
    try {
        ...
        return {
          ...
          anchor: (() => {
            try {
              ...
              console.warn(`[slice] Malformed anchor JSON for comment ${comment.id}`);
      ...
      console.error('[slice] Failed to get document comments:', error);
  ...
  app.post('/api/documents/:id/comments', async (c) => {
    try {
      ...
      console.error('[slice] Failed to create comment:', error);
  ...
  app.patch('/api/documents/:id/comments/:commentId', async (c) => {
    try {
      ...
      console.error('[slice] Failed to update comment:', error);
  ...
  app.delete('/api/documents/:id/comments/:commentId', async (c) => {
    try {
      ...
      console.error('[slice] Failed to delete comment:', error);
  ...
  app.post('/api/documents/:id/comments/:commentId/resolve', async (c) => {
    try {
      ...
      console.error('[slice] Failed to resolve comment:', error);
