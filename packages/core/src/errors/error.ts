...
/**
 * Base error class for all Slice errors.
...
export class SliceError extends Error {
  ...
  constructor(
    ...
    if (Error.captureStackTrace) {
      Error.captureStackTrace(this, SliceError);
    }
  }
 ...
 */
export class ValidationError extends SliceError {
  constructor(
    message: string,
 ...
 */
export class NotFoundError extends SliceError {
  constructor(
    message: string,
 ...
 */
export class ConflictError extends SliceError {
  constructor(
    message: string,
 ...
 */
export class ConstraintError extends SliceError {
  constructor(
    message: string,
 ...
 */
export class StorageError extends SliceError {
  constructor(
    message: string,
...
/**
 * Type guard to check if an error is an SliceError
 */
export function isSliceError(error: unknown): error is SliceError {
  return error instanceof SliceError;
}
 ...
 */
export class IdentityError extends SliceError {
  constructor(
    message: string,
...
export function hasErrorCode(
  ...
  return isSliceError(error) && error.code === code;
}
