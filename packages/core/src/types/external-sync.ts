 ...
 *
 * Types for bidirectional synchronization between Slice elements
...
export interface ExternalTask {
  ...
  /**
   * Native priority value, normalized to Slice priority (1-5).
...
export interface ExternalTaskInput {
  ...
  readonly assignees?: readonly string[];
  /**
   * Native priority value as Slice priority (1-5).
...
/**
 * Describes how a single field maps between Slice and external system
 */
...
/**
 * Configuration for task field mapping between Slice and a provider
 */
...
/**
 * Task-specific sync adapter — maps between Slice tasks and external issues
 */
