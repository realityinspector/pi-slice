/**
 * Slice Platform Server
 *
 * HTTP + WebSocket server for the Slice web platform.
...
// Storage layer
import { createStorage, initializeSchema } from '@slice/storage';
...
export function createQuarryApp(options: QuarryServerOptions = {}): QuarryApp {
  ...
  // Database path - defaults to .slice/slice.db in current working directory
  const PROJECT_ROOT = process.cwd();
  const DEFAULT_DB_PATH = resolve(PROJECT_ROOT, '.slice/slice.db');
  ...
  const UPLOADS_DIR = DB_PATH === ':memory:'
    ? resolve(PROJECT_ROOT, '.slice/uploads')
  ...
  try {
    ...
    console.log(`[slice] Connected to database: ${DB_PATH}`);
  } catch (error) {
  ...
  const autoExportService = createAutoExportService({
    ...
    outputDir: resolve(PROJECT_ROOT, '.slice/sync'),
  });
  autoExportService.start().catch((err: Error) => {
    console.error('[slice] Failed to start auto-export:', err);
  });
  ...
  broadcaster.start().catch((err: Error) => {
    console.error('[slice] Failed to start event broadcaster:', err);
  });
...
app.get('/api/stats', async (c) => {
  try {
    ...
    console.error('[slice] Failed to get stats:', error);
...
app.get('/api/tasks', async (c) => {
  try {
    ...
    console.error('[slice] Failed to get tasks:', error);
...
app.get('/api/tasks/ready', async (c) => {
  try {
    ...
    console.error('[slice] Failed to get ready tasks:', error);
...
app.get('/api/tasks/blocked', async (c) => {
  try {
    ...
    console.error('[slice] Failed to get blocked tasks:', error);
...
app.get('/api/tasks/in-progress', async (c) => {
  try {
    ...
    console.error('[slice] Failed to get in-progress tasks:', error);
...
app.get('/api/tasks/completed', async (c) => {
  try {
    ...
    console.error('[slice] Failed to get completed tasks:', error);
...
app.get('/api/tasks/:id', async (c) => {
  try {
    ...
    console.error('[slice] Failed to get task:', error);
...
app.post('/api/tasks', async (c) => {
  try {
    ...
    console.error('[slice] Failed to create task:', error);
...
app.patch('/api/tasks/:id', async (c) => {
  try {
    ...
    console.error('[slice] Failed to update task:', error);
...
app.delete('/api/tasks/:id', async (c) => {
  try {
    ...
    console.error('[slice] Failed to delete task:', error);
...
app.get('/api/tasks/:id/attachments', async (c) => {
  try {
    ...
    console.error('[slice] Failed to get task attachments:', error);
...
app.post('/api/tasks/:id/attachments', async (c) => {
  try {
    ...
    console.error('[slice] Failed to attach document to task:', error);
...
app.delete('/api/tasks/:id/attachments/:docId', async (c) => {
  try {
    ...
    console.error('[slice] Failed to remove task attachment:', error);
...
app.get('/api/tasks/:id/dependency-tasks', async (c) => {
  try {
    ...
    console.error('[slice] Failed to get dependency tasks:', error);
...
app.get('/api/entities', async (c) => {
  try {
    ...
    console.error('[slice] Failed to get entities:', error);
...
app.post('/api/entities', async (c) => {
  try {
    ...
    console.error('[slice] Failed to create entity:', error);
...
app.get('/api/entities/:id', async (c) => {
  try {
    ...
    console.error('[slice] Failed to get entity:', error);
...
app.patch('/api/entities/:id', async (c) => {
  try {
    ...
    console.error('[slice] Failed to update entity:', error);
...
app.get('/api/entities/:id/tasks', async (c) => {
  try {
    ...
    console.error('[slice] Failed to get entity tasks:', error);
...
app.get('/api/entities/:id/stats', async (c) => {
  try {
    ...
    console.error('[slice] Failed to get entity stats:', error);
...
app.get('/api/entities/:id/events', async (c) => {
  try {
    ...
    console.error('[slice] Failed to get entity events:', error);
...
app.get('/api/entities/:id/history', async (c) => {
  try {
    ...
    console.error('[slice] Failed to get entity history:', error);
...
app.get('/api/entities/:id/activity', async (c) => {
  try {
    ...
    console.error('[slice] Failed to get entity activity:', error);
...
app.get('/api/entities/:id/mentions', async (c) => {
  try {
    ...
    console.error('[slice] Failed to get entity mentions:', error);
...
app.get('/api/entities/:id/inbox', async (c) => {
  try {
    ...
    if (hydrateParam === 'true') {
      ...
      items = await Promise.all(result.items.map(async (item) => {
        try {
          ...
          console.warn(`[slice] Failed to hydrate inbox item ${item.id}:`, err);
          return item;
        }
      }));
    }
    ...
    console.error('[slice] Failed to get entity inbox:', error);
...
app.get('/api/entities/:id/inbox/count', async (c) => {
  try {
    ...
    console.error('[slice] Failed to get inbox count:', error);
...
app.post('/api/entities/:id/inbox/mark-all-read', async (c) => {
  try {
    ...
    console.error('[slice] Failed to mark all as read:', error);
...
app.patch('/api/inbox/:itemId', async (c) => {
  try {
    ...
    console.error('[slice] Failed to update inbox item:', error);
...
app.get('/api/inbox/all', async (c) => {
  try {
    ...
    console.error('[slice] Failed to get global inbox:', error);
...
app.get('/api/inbox/count', async (c) => {
  try {
    ...
    console.error('[slice] Failed to get global inbox count:', error);
...
app.get('/api/inbox/:itemId', async (c) => {
  try {
    ...
    console.error('[slice] Failed to get inbox item:', error);
...
app.get('/api/entities/:id/reports', async (c) => {
  try {
    ...
    console.error('[slice] Failed to get entity reports:', error);
...
app.get('/api/entities/:id/chain', async (c) => {
  try {
    ...
    console.error('[slice] Failed to get management chain:', error);
...
app.patch('/api/entities/:id/manager', async (c) => {
  try {
    ...
    console.error('[slice] Failed to set entity manager:', error);
...
app.get('/api/dependencies/:id/tree', async (c) => {
  try {
    ...
    console.error('[slice] Failed to get dependency tree:', error);
...
app.get('/api/dependencies/:id', async (c) => {
  try {
    ...
    console.error('[slice] Failed to get dependencies:', error);
...
app.post('/api/dependencies', async (c) => {
  try {
    ...
    console.error('[slice] Failed to create dependency:', error);
...
app.delete('/api/dependencies/:blockedId/:blockerId/:type', async (c) => {
  try {
    ...
    console.error('[slice] Failed to remove dependency:', error);
...
app.get('/api/events', async (c) => {
  try {
    ...
    console.error('[slice] Failed to get events:', error);
...
app.get('/api/events/count', async (c) => {
  try {
    ...
    console.error('[slice] Failed to count events:', error);
...
app.get('/api/workflows', async (c) => {
  try {
    ...
    console.error('[slice] Failed to get workflows:', error);
...
app.get('/api/workflows/:id', async (c) => {
  try {
    ...
    console.error('[slice] Failed to get workflow:', error);
...
app.get('/api/workflows/:id/tasks', async (c) => {
  try {
    ...
    console.error('[slice] Failed to get workflow tasks:', error);
...
app.get('/api/workflows/:id/progress', async (c) => {
  try {
    ...
    console.error('[slice] Failed to get workflow progress:', error);
...
app.get('/api/workflows/:id/can-delete-task/:taskId', async (c) => {
  try {
    ...
    console.error('[slice] Failed to check if task can be deleted:', error);
...
app.post('/api/workflows', async (c) => {
  try {
    ...
    console.error('[slice] Failed to create workflow:', error);
...
app.post('/api/workflows/instantiate', async (c) => {
  try {
    ...
    console.error('[slice] Failed to instantiate workflow:', error);
...
app.patch('/api/workflows/:id', async (c) => {
  try {
    ...
    console.error('[slice] Failed to update workflow:', error);
...
app.delete('/api/workflows/:id', async (c) => {
  try {
    ...
    console.error('[slice] Failed to delete workflow:', error);
...
app.post('/api/workflows/:id/promote', async (c) => {
  try {
    ...
    console.error('[slice] Failed to promote workflow:', error);
...
const PLAYBOOK_SEARCH_PATHS = [
  resolve(PROJECT_ROOT, '.slice/playbooks'),
...
app.get('/api/playbooks', async (c) => {
  try {
    ...
    console.error('[slice] Failed to list playbooks:', error);
...
app.get('/api/playbooks/:name', async (c) => {
  try {
    ...
    console.error('[slice] Failed to get playbook:', error);
...
app.get('/api/teams', async (c) => {
  try {
    ...
    console.error('[slice] Failed to get teams:', error);
...
app.post('/api/teams', async (c) => {
  try {
    ...
    console.error('[slice] Failed to create team:', error);
...
app.get('/api/teams/:id', async (c) => {
  try {
    ...
    console.error('[slice] Failed to get team:', error);
...
app.patch('/api/teams/:id', async (c) => {
  try {
    ...
    console.error('[slice] Failed to update team:', error);
...
app.delete('/api/teams/:id', async (c) => {
  try {
    ...
    console.error('[slice] Failed to delete team:', error);
...
app.get('/api/teams/:id/members', async (c) => {
  try {
    ...
    console.error('[slice] Failed to get team members:', error);
...
app.get('/api/teams/:id/stats', async (c) => {
  try {
    ...
    console.error('[slice] Failed to get team stats:', error);
...
app.get('/api/teams/:id/can-remove-member/:entityId', async (c) => {
  try {
    ...
    console.error('[slice] Failed to check can-remove-member:', error);
...
app.get('/api/sync/status', async (c) => {
  try {
    ...
    return c.json({
      ...
      exportPath: resolve(PROJECT_ROOT, '.slice'),
    });
  } catch (error) {
    console.error('[slice] Failed to get sync status:', error);
...
app.post('/api/sync/export', async (c) => {
  try {
    ...
    // Export to JSONL files in .slice directory
    const result = await syncService.export({
      outputDir: resolve(PROJECT_ROOT, '.slice'),
      full: true,
      includeEphemeral,
    });
    ...
    console.error('[slice] Failed to export:', error);
...
app.post('/api/sync/import', async (c) => {
  try {
    ...
    console.error('[slice] Failed to import:', error);
...
app.post('/api/uploads', async (c) => {
  try {
    ...
    console.log(`[slice] Uploaded image: ${filename} (${file.size} bytes)`);
    ...
    console.error('[slice] Failed to upload file:', error);
...
app.get('/api/uploads/:filename/usage', async (c) => {
  try {
    ...
    console.error('[slice] Failed to get upload usage:', error);
...
app.get('/api/uploads/:filename', async (c) => {
  try {
    ...
    console.error('[slice] Failed to serve file:', error);
...
app.get('/api/uploads', async (c) => {
  try {
    ...
    console.error('[slice] Failed to list uploads:', error);
...
app.delete('/api/uploads/:filename', async (c) => {
  try {
    ...
    console.log(`[slice] Deleted upload: ${filename}`);

    return c.json({ success: true, filename });
  } catch (error) {
    console.error('[slice] Failed to delete upload:', error);
...
function startBunServer(
  ...
  console.log(`[slice] Bun server listening on http://${options.host}:${server.port}`);
  return server;
}
    ...
    import('http').then(({ createServer }) => {
      const httpServer = createServer(async (req, res) => {
        ...
        try {
          ...
          console.error('[slice] Request error:', err);
      ...
      httpServer.listen(options.port, options.host, () => {
        console.log(`[slice] Node server listening on http://${options.host}:${options.port}`);
      });
    });
  });
}
...
export function startQuarryServer(options: QuarryServerOptions = {}): QuarryApp {
  ...
  console.log(`[slice] Starting server on http://${host}:${port}`);
