 ...
 * @slice/quarry
 *
 * Core SDK for Slice - API, services, sync, and CLI.
 * This package provides the main programmatic interface to Slice,
 * building on @slice/core for types and @slice/storage for persistence.
 *
 * Note: Types from @slice/core and @slice/storage are NOT re-exported here
 * to avoid naming conflicts. Import them directly:
 *   import { Task, Entity, ... } from '@slice/core';
