 ...
 * 1. Known packages: Auto-detect first-party packages (e.g., @slice/smithy)
 * 2. Config-based: User-specified packages in .slice/config.yaml plugins.packages
 */
 ...
 */
const KNOWN_PLUGIN_PACKAGES = ['@slice/smithy'] as const;
