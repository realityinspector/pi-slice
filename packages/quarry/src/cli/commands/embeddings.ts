...
import { DocumentStatus, type Document, type ElementId } from '@slice/core';
...
import { createAPI, SLICE_DIR } from '../db.js';
...
async function embeddingsInstallHandler(
  ...
  const modelDir = join(process.cwd(), SLICE_DIR, MODELS_DIR, DEFAULT_MODEL);
...
The model is stored in .slice/models/ and used for semantic search.
