...
import type { Element, Dependency } from '@slice/core';
import { ValidationError, ErrorCode, isElement, validateElement, isDependency, validateDependency } from '@slice/core';
