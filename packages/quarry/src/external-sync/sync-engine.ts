/**
 * Sync Engine — orchestrates push/pull operations between Slice and external services
 *
 * The sync engine coordinates bidirectional synchronization between Slice elements
 ...
 * - pull(): Pull externally-changed items into Slice
 ...
 * Usage:
 * ```typescript
 * import { createSyncEngine } from '@slice/quarry';
 *
...
import { createTimestamp } from '@slice/core';
...
export interface SyncConflictResolver {
   ...
   *
   * @param localElement - The local Slice element
...
/**
 * Sync Engine — coordinates push/pull operations between Slice and external services.
 *
...
export class SyncEngine {
  ...
  /**
   * Pull externally-changed items into Slice.
   *
   * Algorithm:
   ...
   *    b. If unlinked and options.all is set, create a new Slice task
  ...
  /**
   * Pull a single external item into Slice.
   *
  ...
  /**
   * Pull a single external document into Slice.
  ...
  /**
   * Create a new Slice document from an unlinked external document.
   */
  ...
  /**
   * Create a new Slice task from an unlinked external item.
   */
