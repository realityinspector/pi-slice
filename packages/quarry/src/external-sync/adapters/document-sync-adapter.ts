 ...
 *
 * Shared field mapping logic for converting between Slice documents and
 ...
 *
 * Key functions:
 * - documentToExternalDocumentInput: Convert a Slice Document → ExternalDocumentInput for push
...
import type { ExternalDocument, ExternalDocumentInput } from '@slice/core';
...
/**
 * Maps Slice ContentType to external document content type.
 *
 * Slice uses 'markdown', 'text', and 'json'.
...
/**
 * Maps external document content type to Slice ContentType.
 *
 * External systems use 'markdown', 'text', and 'html'.
 * HTML content is mapped to 'text' since Slice doesn't have an HTML
...
export function mapContentTypeFromExternal(
  ...
  switch (contentType) {
    ...
    case 'text':
      return 'text';
    case 'html':
      // HTML doesn't have a direct Slice equivalent; map to text
      return 'text';
    default:
      return 'text';
  }
...
// ============================================================================
// Push: Slice Document → External Document
// ============================================================================

/**
 * Converts a Slice Document into an ExternalDocumentInput for
 ...
 *
 * @param doc - The Slice document to convert
...
// ============================================================================
// Pull: External Document → Slice Document Updates
// ============================================================================

/**
 * Converts an ExternalDocument into a partial Document update object for
 * applying external changes to a local Slice document.
 *
 * Handles:
 * - Title mapping (1:1)
 * - Content mapping (1:1)
