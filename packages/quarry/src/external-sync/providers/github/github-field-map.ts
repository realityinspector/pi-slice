 ...
 *
 * Defines how Slice task fields map to GitHub issue fields.
...
import type { TaskStatus, Priority, TaskTypeValue } from '@slice/core';
...
/**
 * Maps Slice priority values (1-5) to GitHub label names.
...
/**
 * Maps Slice task type values to GitHub label names.
...
/**
 * Prefix for Slice-managed labels on GitHub issues.
...
/**
 * Maps Slice TaskStatus values to GitHub label names.
 * These labels are prefixed with 'sf:' when pushed to GitHub to
...
/**
 * Maps Slice TaskStatus to GitHub issue state.
 *
 * GitHub only supports two issue states: 'open' and 'closed'.
 * Most Slice statuses map to 'open' since GitHub can't
...
/**
 * Maps GitHub issue state + labels back to Slice TaskStatus.
 *
 ...
 * Slice tasks and GitHub issues (in both push and pull directions).
 */
