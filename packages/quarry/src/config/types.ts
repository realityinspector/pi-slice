 ...
 *
 * Defines all configuration interfaces and types for the Slice system.
...
export interface Configuration {
  ...
  baseBranch?: string;
  /** Database filename (default: 'slice.db') */
  database: string;
  /** Sync settings */
  sync: SyncConfig;
  /** Playbook settings */
